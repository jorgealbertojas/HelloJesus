package com.softjads.jorge.hellojesus.tipWord;
...
import com.softjads.jorge.hellojesus.util.buttonAnimation.MorphingButton;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnMorph4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                openBrowserImage(getActivity(),mTextValue);
        ...
        btnMorph5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                openBrowserExplanation(getActivity(),mTextValue);
            }
        });
        ...
        btnMorph6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                openBrowserTranslate(getActivity(),mTextValue);
            }
        });
