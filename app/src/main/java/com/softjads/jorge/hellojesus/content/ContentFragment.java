...
import com.softjads.jorge.hellojesus.util.download.Download;
import com.softjads.jorge.hellojesus.util.download.DownloadService;
...
import static com.softjads.jorge.hellojesus.util.download.Utility.FILE_DOWNLOAD_COMPLETE;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!((TextView) v).getTag().toString().equals("")) {
       ...
       // mPresenter.HideFabButton(mFloatingActionButton, mHideFab);
        ...
        mFabImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleFabMenu();
                mPresenter.openBrowserImage(getActivity(),mWord);
        ...
        mFabExplanation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleFabMenu();
                mPresenter.openBrowserExplanation(getActivity(),mWord);
        ...
        mFabTranslate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleFabMenu();
                mPresenter.openBrowserTranslate(getActivity(),mWord);
